const Ziggy = {
  ...
  routes: {
    ...
    'auth.login.form': { uri: 'login', methods: ['GET', 'HEAD'] },
    'auth.login.attempt': { uri: 'login', methods: ['POST'] },
    'auth.forgotPassword.form': { uri: 'password/forgot', methods: ['GET', 'HEAD'] },
    'auth.forgotPassword.sendLink': { uri: 'password/forgot', methods: ['POST'] },
    'auth.newPassword.form': {
      uri: 'password/new/{token}',
      methods: ['GET', 'HEAD'],
      parameters: ['token'],
    },
    'auth.newPassword.save': { uri: 'password/new', methods: ['POST'] },
    'auth.login.social.google': { uri: 'auth/google', methods: ['GET', 'HEAD'] },
    ...
    'projects.task-groups.update': {
      ...
      methods: ['PUT'],
      parameters: ['project', 'taskGroup'],
      bindings: { project: 'id', taskGroup: 'id' },
    },
    ...
    'projects.task-groups.restore': {
      ...
      methods: ['POST'],
      parameters: ['project', 'taskGroupId'],
      bindings: { project: 'id' },
    },
    ...
    'projects.tasks.time-logs.destroy': {
      ...
      methods: ['DELETE'],
      parameters: ['project', 'task', 'timeLog'],
      bindings: { project: 'id', task: 'id', timeLog: 'id' },
    },
    ...
    'my-work.tasks.index': { uri: 'my-work/tasks', methods: ['GET', 'HEAD'] },
    'my-work.activity.index': { uri: 'my-work/activity', methods: ['GET', 'HEAD'] },
    'clients.users.index': { uri: 'clients/users', methods: ['GET', 'HEAD'] },
    'clients.users.create': { uri: 'clients/users/create', methods: ['GET', 'HEAD'] },
    'clients.users.store': { uri: 'clients/users', methods: ['POST'] },
    'clients.users.edit': {
    ...
    'clients.companies.index': { uri: 'clients/companies', methods: ['GET', 'HEAD'] },
    'clients.companies.create': { uri: 'clients/companies/create', methods: ['GET', 'HEAD'] },
    'clients.companies.store': { uri: 'clients/companies', methods: ['POST'] },
    ...
    'users.restore': { uri: 'users/{userId}/restore', methods: ['POST'], parameters: ['userId'] },
    ...
    'invoices.tasks': { uri: 'invoices/tasks', methods: ['GET', 'HEAD'] },
    'invoices.status': {
    ...
    'reports.logged-time.sum': { uri: 'reports/logged-time/sum', methods: ['GET', 'HEAD'] },
    'reports.logged-time.daily': { uri: 'reports/logged-time/daily', methods: ['GET', 'HEAD'] },
    'reports.fixed-price.sum': { uri: 'reports/fixed-price/sum', methods: ['GET', 'HEAD'] },
    'settings.company.edit': { uri: 'settings/company', methods: ['GET', 'HEAD'] },
    'settings.company.update': { uri: 'settings/company', methods: ['PUT'] },
    'settings.roles.index': { uri: 'settings/roles', methods: ['GET', 'HEAD'] },
    'settings.roles.create': { uri: 'settings/roles/create', methods: ['GET', 'HEAD'] },
    'settings.roles.store': { uri: 'settings/roles', methods: ['POST'] },
    'settings.roles.edit': {
    ...
    'settings.labels.index': { uri: 'settings/labels', methods: ['GET', 'HEAD'] },
    'settings.labels.create': { uri: 'settings/labels/create', methods: ['GET', 'HEAD'] },
    'settings.labels.store': { uri: 'settings/labels', methods: ['POST'] },
    ...
    'settings.task-priorities.index': { uri: 'settings/task-priorities', methods: ['GET', 'HEAD'] },
    'settings.task-priorities.create': {
      uri: 'settings/task-priorities/create',
      methods: ['GET', 'HEAD'],
    },
    'settings.task-priorities.store': { uri: 'settings/task-priorities', methods: ['POST'] },
    ...
    'account.profile.edit': { uri: 'account/profile', methods: ['GET', 'HEAD'] },
    'account.profile.update': { uri: 'account/profile', methods: ['PUT'] },
    notifications: { uri: 'notifications', methods: ['GET', 'HEAD'] },
    'notifications.read': {
    ...
    'notifications.read.all': { uri: 'notifications/read/all', methods: ['PUT'] },
    'dropdown.values': { uri: 'dropdown/values', methods: ['GET', 'HEAD'] },
  },
};
